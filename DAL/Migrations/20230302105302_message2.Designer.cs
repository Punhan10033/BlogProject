...
namespace DAL.Migrations
{
    ...
    [Migration("20230302105302_message2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Message", b =>
                {
                    ...
                    b.Property<int?>("Message2MessageId")
                        .HasColumnType("int");

                    b.Property<int?>("Message2MessageId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Message2MessageId");

                    b.HasIndex("Message2MessageId1");
            ...
            modelBuilder.Entity("Entities.Message", b =>
                {
                    b.HasOne("Entities.Message2", null)
                        .WithMany("UserReceiever")
                        .HasForeignKey("Message2MessageId");

                    b.HasOne("Entities.Message2", null)
                        .WithMany("UserSender")
                        .HasForeignKey("Message2MessageId1");
                });
